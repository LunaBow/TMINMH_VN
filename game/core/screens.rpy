...
screen input(prompt):
    ...
    frame:
        ...
        vbox:
            spacing 20
            # The prompt text
            text prompt style "terminal_prompt" 
            # The actual typing field
            input id "input" style "terminal_input"
...
screen desktop_interface():
    ...
    if perm_pc_files:
        imagebutton:
            ...
            action Show("file_viewer", filename="poems.txt")
            tooltip "Open Folder"

screen file_viewer(filename):
    modal True
    frame:
        ...
        padding (20, 20)
        vbox:
            text "[filename]" color mint size 30
            null height 20
            if filename == "poems.txt":
                text "longing for dissociation / because I can't stand..." size 22
            textbutton "Close" action Hide("file_viewer") xalign 1.0